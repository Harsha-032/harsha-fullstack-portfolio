ICON_CHOICES = (
    ('default', 'Default/Custom Icon'),
    ('aave', 'aave'),
    ('ableton', 'ableton'),
    ('acrobat', 'acrobat'),
    ('activitypub', 'activitypub'),
    ('actix', 'actix'),
    ('adobespark', 'adobespark'),
    ('adonis', 'adonis'),
    ('ae', 'ae'),
    ('aero', 'aero'),
    ('affinity', 'affinity'),
    ...
    ('lightning', 'lightning'),
    ('lightroom', 'lightroom'),
    ('lightroomclassic', 'lightroomclassic'),
    ('linkedin', 'linkedin'),
    ('linux', 'linux'),
    ...
    ('phaser', 'phaser'),
    ('photoshop', 'photoshop'),
    ('photoshopclassic', 'photoshopclassic'),
    ('photoshopexpress', 'photoshopexpress'),
    ('php', 'php'),
    ('phpstan', 'phpstan'),
    ('phpstorm', 'phpstorm'),
    ('picocss', 'picocss'),
    ...
    ('vitepress', 'vitepress'),
    ('vitest', 'vitest'),
    ('vmwareworkstation', 'vmwareworkstation'),
    ('vscode', 'vscode'),
