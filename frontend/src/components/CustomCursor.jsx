...
export default function CustomCursor() {
  ...
  return (
    <div className="pointer-events-none fixed inset-0 z-[99999]">
      ...
      >
        <svg viewBox="0 0 100 100" className="w-full h-full drop-shadow-[0_0_8px_rgba(0,0,0,0.8)]" style={{ fill: activeTheme.sky.start, opacity: 0.5 }}>
           {/* Beautiful curved 4-point star */}
           <path d="M50 0C50 27.6142 72.3858 50 100 50C72.3858 50 50 72.3858 50 100C50 72.3858 27.6142 50 0 50C27.6142 50 50 27.6142 50 0Z" stroke="#ffffff" strokeWidth="3"/>
        </svg>
      </motion.div>
      ...
      >
        <svg viewBox="0 0 100 100" className="w-full h-full drop-shadow-[0_0_5px_rgba(0,0,0,0.8)]" style={{ fill: activeTheme.sky.start }}>
           <path d="M50 5C50 29 71 50 95 50C71 50 50 71 50 95C50 71 29 50 5 50C29 50 50 29 50 5Z" stroke="#ffffff" strokeWidth="4"/>
        </svg>
        {isHovered && (
          <motion.div
      ...
      <motion.div
        ...
        style={{
          ...
          borderColor: isHovered ? activeTheme.sky.start : '#ffffff',
          backgroundColor: isHovered ? `${activeTheme.sky.start}4D` : 'rgba(255,255,255,0.1)',
          boxShadow: isHovered ? `0 0 15px ${activeTheme.sky.start}66, inset 0 0 10px rgba(0,0,0,0.5)` : '0 0 8px rgba(0,0,0,0.6)',
      ...
      >
        <svg viewBox="0 0 100 100" className="w-full h-full drop-shadow-[0_0_4px_rgba(0,0,0,0.9)]" style={{ fill: isHovered ? '#FFFFFF' : activeTheme.sky.start }}>
           <path d="M50 0C50 27.6142 72.3858 50 100 50C72.3858 50 50 72.3858 50 100C50 72.3858 27.6142 50 0 50C27.6142 50 50 27.6142 50 0Z" stroke="#ffffff" strokeWidth="8"/>
        </svg>
      </motion.div>
    </div>
  );
